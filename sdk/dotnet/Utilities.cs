...
namespace Pulumi.Linux
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Linux.version.txt");
    ...
    internal sealed class LinuxResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LinuxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
