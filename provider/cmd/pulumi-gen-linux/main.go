...
import (
	...
	providerVersion "github.com/ikozinov/pulumi-linux/provider/pkg/version"
...
// BaseDir is the path to the base pulumi-linux directory.
var BaseDir string
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <swagger-or-schema-file> <root-pulumi-linux-dir>"
